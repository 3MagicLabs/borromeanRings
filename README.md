...
The required set is declared in `borromeanrings.toml` `[checks].required` (twenty-seven gates
...
**36 checks** across the shared / Python / heavy-CI lanes — what each enforces, its config
...
<!-- describe:begin -->
**36 checks** across three lanes — 15 shared, 17 Python, 4 heavy/CI — of which **27 are required on this repo** and 6 are threshold-free ratchets.
