...
The required set is declared in `borromeanrings.toml` `[checks].required` (38 gates
...
**38 checks** across the shared / Python / heavy-CI lanes — what each enforces, its config
...
<!-- describe:begin -->
**38 checks** across three lanes — 15 shared, 17 Python, 6 heavy/CI — of which **27 are required on this repo** and 6 are threshold-free ratchets.
