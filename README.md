...
The required set is declared in `borromeanrings.toml` `[checks].required` (twenty-eight gates
...
**39 checks** across the shared / Python / heavy-CI lanes — what each enforces, its config
...
<!-- describe:begin -->
**39 checks** across three lanes — 16 shared, 17 Python, 6 heavy/CI — of which **28 are required on this repo** and 6 are threshold-free ratchets.
