...
borromeanRings **enforces** that the rewrite happens, and happens well.
...
- The agent performs the rewrite and shows it. borromeanRings enforced the process; it wrote nothing itself.
