...
| [0078](0078-headless-generator-and-loop-conformance.md) | The headless generator: one decision, two thin drivers, and provenance in the verdict (builds ADR-0071 for #202) | Accepted |
