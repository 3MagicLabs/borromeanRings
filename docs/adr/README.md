...
| [0058](0058-trunk-based-branch-policy-enforcement.md) | Branch policy enforced: nothing lands on a protected branch except via PR + gate (guard + `08_branch` backstop) | Accepted |
